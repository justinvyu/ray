...
def bundle_to_remote_args(bundle: dict) -> dict:
    ...
    >>> bundle_to_remote_args({"GPU": 1, "memory": 1, "object_store_memory": 1024, "custom": 0.1})
    {'num_cpus': 0, 'num_gpus': 1, 'memory': 1, 'object_store_memory': 1024, 'resources': {'custom': 0.1}}
    """
    bundle = bundle.copy()
    args = {
        ...
        "object_store_memory": bundle.pop("object_store_memory", 0),
    }
    if bundle:
